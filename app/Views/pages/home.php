    ...
    <?php if (!empty($slides)): ?>
      <?php foreach ($slides as $index => $slide): ?>
        <div class="hero-slide absolute inset-0 w-full h-full <?= $index === 0 ? 'opacity-100' : 'opacity-0' ?> transition-opacity duration-1000 ease-in-out" 
             ...
             data-btn1-text="<?= esc($slide['btn1_text'] ?? 'WhatsApp: 919425100000') ?>"
             data-btn1-link="<?= esc($slide['btn1_link']) ?>"
             data-btn2-text="<?= esc($slide['btn2_text'] ?? 'Call Now') ?>"
    ...
    <div class="max-w-2xl space-y-5 sm:space-y-6 md:space-y-8">
      ...
      <div class="space-y-4 pt-2">
        <div class="flex flex-wrap items-center gap-3">
          <?php
            $heroWaNum  = '919425100000';
            $heroWaLink = (!empty($slides[0]['btn1_link']))
              ? $slides[0]['btn1_link']
              : get_whatsapp_link(get_whatsapp_number($heroWaNum), 'Hi Kanha Kisli Holiday, I would like to inquire about stay and safari booking');
          ...
          <a id="hero-btn-wa" 
             ...
             title="WhatsApp: <?= esc(get_clean_whatsapp($heroWaNum)) ?>"
            ...
            <span id="hero-btn-wa-text"><?= esc($slides[0]['btn1_text'] ?? 'WhatsApp: 919425100000') ?></span>
          </a>
