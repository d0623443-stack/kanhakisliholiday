...
<script>
  ...
  function openEditSlideModal(slide) {
    ...
    document.getElementById('modal-btn1').value = slide.btn1_text || 'WhatsApp: 919425100000';
    document.getElementById('modal-btn1-link').value = slide.btn1_link || '<?= esc(get_whatsapp_link("919425100000", "Hi Kanha Kisli Holiday, I would like to inquire about stay and safari booking")) ?>';
  ...
  function openAddSlideModal() {
    ...
    document.getElementById('modal-btn1').value = 'WhatsApp: 919425100000';
    document.getElementById('modal-btn1-link').value = '<?= esc(get_whatsapp_link("919425100000", "Hi Kanha Kisli Holiday, I would like to inquire about stay and safari booking")) ?>';
